...
import com.vidiun.client.VidiunLoggerAndroid;

abstract public class VidiunLogger implements IVidiunLogger
{
	// Creation & retrieval methods:
	public static VidiunLogger getLogger(String name)
	{
		return VidiunLoggerAndroid.getLogger(name);
	}
	
	public static VidiunLogger getLogger(Class<?> clazz)
	{
