# Vidiun OTT Angular X Client

[![Conventional Commits](https://img.shields.io/badge/Conventional%20Commits-1.0.0-yellow.svg)](https://conventionalcommits.org) [![Gitter chat](https://badges.gitter.im/vidiun-ng/vidiun-ng.png)](https://gitter.im/vidiun-ng/vidiun-ng) [![Build Status](https://travis-ci.org/vidiun/VidiunGeneratedAPIClientsAngular.svg?branch=master)](https://travis-ci.org/vidiun/VidiunOttGeneratedAPIClientsNgx)

> An easy-to-use facade to Vidiun OTT server with Angular X support for action requests, classes and enums.
