...
import {VidiunDetachedResponseProfile} from "../api/types/VidiunDetachedResponseProfile";
import {VidiunBaseEntryFilter} from "../api/types/VidiunBaseEntryFilter";
import {VidiunSearchOperator} from "../api/types/VidiunSearchOperator";
import {VidiunNullableBoolean} from "../api/types/VidiunNullableBoolean";
import {AppTokenAddAction} from "../api/types/AppTokenAddAction";
import {VidiunAppToken} from "../api/types/VidiunAppToken";
import {VidiunSearchOperatorType} from "../api/types/VidiunSearchOperatorType";
import {VidiunContentDistributionSearchItem} from "../api/types/VidiunContentDistributionSearchItem";
import {UserGetAction} from "../api/types/UserGetAction";
import {PlaylistListAction} from "../api/types/PlaylistListAction";
import {VidiunBaseEntryListResponse} from "../api/types/VidiunBaseEntryListResponse";
...
import {VidiunEntryReplacementStatus} from "../api/types/VidiunEntryReplacementStatus";
import {VidiunMediaEntryFilter} from "../api/types/VidiunMediaEntryFilter";
import {VidiunMediaEntryFilterForPlaylist} from "../api/types/VidiunMediaEntryFilterForPlaylist";
import {VidiunAPIException} from "../api/vidiun-api-exception";
import {VidiunAppTokenHashType} from "../api/types/VidiunAppTokenHashType";
...
import {VidiunFilterPager} from "../api/types/VidiunFilterPager";
...
describe("Vidiun server API request", () => {
	...
	describe("Invoking vidiun response", () => {
		test("parse action response type", (done) => {
			...
			expect.assertions(1);
			vidiunClient.request(listAction).then(
				(response) => {
					asyncAssert(() => {
		...
		test("parse number response property while provided value is boolean", (done) => {
			expect.assertions(2);
			vidiunClient.request(new PartnerGetAction({id: TestsConfig.partnerId})).then(
				(response) => {
					asyncAssert(() => {
						expect(response).toBeDefined();
